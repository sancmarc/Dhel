...
<head>
    ...
    <title>Tables : Hi-QM-Furniture</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <section id="coverTop">
    <img src="{{asset('img/table-cover.jpg')}}" class="img-fluid w-100" alt="Table Wrought Iron top Page">
    </section>
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <div class="mt-5">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end my-3">
                    <button type="button" class="btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addTable">
                        <i class="bi bi-plus"></i> Table
                    </button>
                </div>
                ...
                <div class="modal fade" id="addTable" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addTableLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="{{route('add.table')}}" method="post" enctype="multipart/form-data" id="tableForm">
                                @csrf
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label for="table_name" class="form-label">{{ __('Name') }}</label>
                                            <input id="table_name" type="text" class="form-control" name="table_name" autocomplete="table_name">
                                            <span class="error-text text-danger table_name_error">
                                        </div>
                                    ...
                                    <div class="row my-3">
                                        <div class="col-md-12 ">
                                            <label for="table_image" class="form-label">{{ __('Table Image') }}</label>
                                            <input type="file" name="table_image" id="table_image" class="form-control">

                                            <span class="error-text text-danger table_image_error">
                                    ...
                                    <div class="row my-3">
                                        <div class="col-md-12 ">
                                            <label for="description" class="form-label">{{ __('Table Description') }}</label>
    ...
    <script>
        ...
        //Reset input file
        $('input[type="file"][name="table_image"]').val('');
        //Image preview
        $('input[type="file"][name="table_image"]').on('change', function() {
