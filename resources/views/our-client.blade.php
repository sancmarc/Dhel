...
<body class="d-flex flex-column min-vh-100">
    ...
    <section class="container mt-5">
        <h1 class="text-center mt-5">Our Client & Finish Goods</h1>
        <div class="row">
    ...
    <section class="container mt-5" id="chair-row">
        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            ...
            <a href="{{route('client.video')}}">See Our Videos</a>
            </div>
        </div>
        @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button type="button" class="btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addClient">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addClientLabel">Add Chair</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="{{route('add.client')}}" method="post" enctype="multipart/form-data" id="chairForm">
                            @csrf
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="client_name" class="form-label">{{ __('Name') }}</label>
                                        <input id="client_name" type="text" class="form-control" name="client_name" autocomplete="client_name">
                                        <span class="error-text text-danger client_name_error">
                                    </div>
                                ...
                                <div class="row my-3">
                                    <div class="col-md-12 ">
                                        <label for="client_image" class="form-label">{{ __('Image') }}</label>
                                        <input type="file" name="client_image" id="client_image" class="form-control">

                                        <span class="error-text text-danger client_image_error">
    ...
    <script>
        ...
        //Reset input file
        $('input[type="file"][name="client_image"]').val('');
        //Image preview
        $('input[type="file"][name="client_image"]').on('change', function() {
